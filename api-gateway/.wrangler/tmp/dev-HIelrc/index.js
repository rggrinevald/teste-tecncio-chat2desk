...
// .wrangler/tmp/bundle-tMwMx4/checked-fetch.js
...
// .wrangler/tmp/bundle-tMwMx4/strip-cf-connecting-ip-header.js
...
var authMiddleware = createMiddleware(async (c, next) => {
  ...
  if (!authHeader?.startsWith("Bearer ")) {
    return c.json({ error: "Token de autentica\xE7\xE3o n\xE3o fornecido" }, 401);
  }
...
// .wrangler/tmp/bundle-tMwMx4/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-tMwMx4/middleware-loader.entry.ts
